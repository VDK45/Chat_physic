...
class Game():
    ...
    def game_run(self, camera, clock, font, world):
        ...
        # Платформа
        segment_shape = pymunk.Segment(space.static_body, (0, self.camera_height), (self.camera_width, self.camera_height), 20)
        ...
        while True:
            for event in pg.event.get():
                ...
                if event.type == pg.MOUSEBUTTONDOWN:
                    ...
                    if event.button == 3:
                        mouse_pos = pg.mouse.get_pos()
                        # doo = DooFree(mouse_pos[0], mouse_pos[1])
                        # space.add(doo, doo.body)
